...
class Login extends JFrame implements KeyListener {
	...
	public Login() {
		...
		loginText = new JTextField("NewUser", 15);
		loginText.setFont(new Font("",Font.BOLD,15));
	}
...
class Menu extends JFrame implements KeyListener {
	 ...
	 */
	public static String choice[] = {"Fried Chicken ",
								   	"Fried Noodles   ",
					   				"Mixed Meat Rice ",
					   				"Uzbek Pilaf     ",  
					   				"Sandwiches      ",
...
class SubTotal extends JFrame implements KeyListener {
	...
	public SubTotal() {
		...
		subTotalTitleLabel.setForeground(Color.red);
		...
		subTotalOrderedPanel.setBackground(new Color(0,77,230));
